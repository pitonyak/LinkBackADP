...
SimpleLoggerRoutingInfo::SimpleLoggerRoutingInfo(const SimpleLoggerRoutingInfo& obj) : QObject(obj.parent()), m_levels(nullptr), m_routing(nullptr), m_regExp(nullptr)
{
  m_levels = new QMap<MessageCategory, int>();
  m_routing = new QMap<MessageRouting, bool>();
  copy(obj);
